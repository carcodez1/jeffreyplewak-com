---
name: cleanup-audit
description: Deterministic cleanup audit workflow for UI/CSS/SEO/a11y/perf risk scanning.
...
- Update npm `"check"` or `"prepush"` only if it stays fast (<2s); otherwise keep as optional gate.
